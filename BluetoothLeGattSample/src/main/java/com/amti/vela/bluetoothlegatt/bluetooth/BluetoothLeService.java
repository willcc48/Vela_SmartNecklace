...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_RSSI_DATA_AVAILABLE =
            "com.example.bluetooth.le.ACTION_RSSI_DATA_AVAILABLE";
    ...
    public final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onReadRemoteRssi(BluetoothGatt gatt, int rssi, int status) {
            ...
            broadcastUpdate(ACTION_RSSI_DATA_AVAILABLE, rssi);
        }
    ...
    public boolean onUnbind(Intent intent) {
        // After using a given device, you should make sure that BluetoothGatt.() is called
    ...
    public void setCharacteristicNotification(final BluetoothGattCharacteristic characteristic,
        ...
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                if (MainActivity.NOTIFICATION_UUID.equals(characteristic.getUuid().toString()) && mBluetoothAdapter != null && mBluetoothGatt != null) {
